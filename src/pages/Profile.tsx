          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="relative group">
              <div className="w-32 h-32 rounded-3xl bg-slate-100 overflow-hidden border-4 border-white shadow-lg">
                <img 
                  src={formData.photoUrl || `https://ui-avatars.com/api/?name=${user.fullName}&background=3b82f6&color=fff&size=256`} 
                  alt="Profile" 
                  className="w-full h-full object-cover"
                />
              </div>
              {isEditing && (
                <button className="absolute bottom-2 right-2 p-2 bg-blue-500 text-white rounded-xl shadow-lg hover:bg-blue-600 transition-all">
                  <Camera size={16} />
                </button>
              )}
            </div>
